 ...
 * 
 * This script is used to encrypt your OpenAI API key for use in the extension.
 * Run this script locally with your API key, then copy the generated chunks
 * into the photo-service.js file.
 * 
 ...
 * 2. Run: node encrypt-api-key.js
 * 3. Copy the generated K1, K2, K3, K4 values to photo-service.js
...
class APIKeySetup {
  ...
  static generateEncryptedKey() {
    ...
    console.log('Copy these lines into photo-service.js (replace the placeholder values):\n');
    console.log('----------------------------------------');
    ...
    console.log('1. Save photo-service.js');
    console.log('2. Delete or secure this encrypt-api-key.js file');
    console.log('3. Test the photo checker in the extension\n');
  }
}

// Run the encryption
APIKeySetup.generateEncryptedKey();