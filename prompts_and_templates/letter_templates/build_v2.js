...
// Read V1 template
const v1Path = path.join(__dirname, 'e2_manager_template.md');
const v1Content = fs.readFileSync(v1Path, 'utf8');
const v1Lines = v1Content.split('\n');

console.log(`Read V1 template: ${v1Lines.length} lines`);

// Build V2 by inserting enhancements at specific line numbers
let v2Lines = [];

// ENHANCEMENT 1: Version header (before line 1)
const versionHeader = `# E2 Manager Letter Template V2 - Legal Advocacy Framework Edition
...
v2Lines.push(...versionHeader.split('\n'));

// Add lines 1-86 (up to CRITICAL SUBSTANCE RULES)
v2Lines.push(...v1Lines.slice(0, 86));

// ENHANCEMENT 2: Replace CRITICAL SUBSTANCE RULES (lines 87-94 become new version)
const enhancedSubstanceRules = `**CRITICAL SUBSTANCE RULES - LEGAL ADVOCACY MANDATE**
...
v2Lines.push(enhancedSubstanceRules);

// Add lines 95-110 (DEPTH AND DETAIL MANDATE through MINDSET INSTRUCTION)
v2Lines.push(...v1Lines.slice(94, 110));

// ENHANCEMENT 3: Add Legal Advocacy Framework (after line 110, before "WHAT TO EXPECT")
const legalAdvocacyFramework = `
...
v2Lines.push(...legalAdvocacyFramework.split('\n'));

// Add lines 111-130 (WHAT TO EXPECT through to before BUILD POSITION section)
v2Lines.push(...v1Lines.slice(110, 130));

// ENHANCEMENT 4: Replace BUILD POSITION FROM BACKGROUND (lines 131-159)
const enhancedBuildPosition = `**⚠️ CRITICAL: BUILD CREDIBLE POSITION FROM BENEFICIARY'S BACKGROUND**
...
v2Lines.push(...enhancedBuildPosition.split('\n'));

// Add lines 160-209 (through to Opening Paragraph Standards)
v2Lines.push(...v1Lines.slice(159, 209));

// ENHANCEMENT 5: Add Advocacy Note before Opening Paragraph Standards (after line 209)
const advocacyNote = `
...
v2Lines.push(...advocacyNote.split('\n'));

// Add lines 210-233 (Opening Paragraph Standards through before E2 Managerial Duties)
v2Lines.push(...v1Lines.slice(209, 233));

// ENHANCEMENT 6: Add Advocacy Framework for Duties (after line 233)
const dutiesAdvocacyFramework = `
...
v2Lines.push(...dutiesAdvocacyFramework.split('\n'));

// Add lines 234-395 (Critical E2 Managerial Duty Categories through Specificity Balance)
v2Lines.push(...v1Lines.slice(233, 395));

// ENHANCEMENT 8: Add When to Advocate vs Document (after line 395)
const advocateVsDocument = `
...
v2Lines.push(...advocateVsDocument.split('\n'));

// Add lines 396-415 (Examples through before Content Elimination)
v2Lines.push(...v1Lines.slice(395, 415));

// ENHANCEMENT 7: Replace Content Elimination Rules (lines 416-428)
const contentElevationRules = `## Content Elevation Rules - Advocacy Approach
...
v2Lines.push(...contentElevationRules.split('\n'));

// Add lines 429-549 (Professional Tone through to Job History Format)
v2Lines.push(...v1Lines.slice(428, 549));

// ENHANCEMENT 9: Add Advocacy vs Documentation in Work History (after line 549)
const workHistoryAdvocacy = `
...
v2Lines.push(...workHistoryAdvocacy.split('\n'));

// Add lines 550-697 (through Document Analysis Standards)
v2Lines.push(...v1Lines.slice(549, 697));

// ENHANCEMENT 10: Add Dual-Purpose Analysis (after line 697)
const dualPurposeAnalysis = `
...
v2Lines.push(...dualPurposeAnalysis.split('\n'));

// Add remaining lines from V1 (lines 698-end)
v2Lines.push(...v1Lines.slice(697));

// Write V2 file
const v2Path = path.join(__dirname, 'e2_manager_template_v2.md');
const v2Content = v2Lines.join('\n');

fs.writeFileSync(v2Path, v2Content, 'utf8');

console.log(`\nV2 template created successfully!`);
console.log(`- Location: ${v2Path}`);
console.log(`- V1 lines: ${v1Lines.length}`);
console.log(`- V2 lines: ${v2Lines.length}`);
console.log(`- Lines added: ${v2Lines.length - v1Lines.length}`);
console.log(`\nEnhancements applied:`);
console.log(`✅ 1. Version header (25 lines)`);
console.log(`✅ 2. Enhanced Critical Substance Rules (30 lines)`);
console.log(`✅ 3. Legal Advocacy Framework section (100 lines)`);
console.log(`✅ 4. Rewritten Build Position section (80 lines)`);
console.log(`✅ 5. Advocacy note before Opening (15 lines)`);
console.log(`✅ 6. Duties advocacy framework (30 lines)`);
console.log(`✅ 7. Content Elevation Rules (30 lines)`);
console.log(`✅ 8. When to Advocate vs Document (35 lines)`);
console.log(`✅ 9. Work History advocacy guidance (40 lines)`);
console.log(`✅ 10. Dual-Purpose Analysis (60 lines)`);
